...
from tensorflow.keras.layers import (Input, Conv2D, BatchNormalization, Activation, Dropout, MaxPooling2D, 
                                     UpSampling2D, Flatten, Dense, Reshape)
...
class QuantumLayer(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        def quantum_fn(x):
            ...
            # print(drawer(x, qml.numpy.array(self.quantum_weights)))            
...
def binary_segnet_with_quantum_layer(IMG_CHANNELS, LearnRate):
    inputs = Input(shape=(64, 64, IMG_CHANNELS))
    ...
    b1 = Conv2D(256, (3, 3), padding='same', kernel_initializer='glorot_uniform')(p4)
    b1 = BatchNormalization()(b1)
    b1 = Activation('relu')(b1)
    b1 = Dropout(0.1)(b1)
    b1 = Conv2D(256, (3, 3), padding='same', kernel_initializer='glorot_uniform')(b1)
    b1 = BatchNormalization()(b1)
    b1 = Activation('relu')(b1)

    # Quantum layer
    quantum_input = Flatten()(b1)
    ...
    u4 = UpSampling2D((2, 2))(quantum_output)
...
IMG_CHANNELS = 3
LearnRate = 0.001
model = binary_segnet_with_quantum_layer(IMG_CHANNELS, LearnRate)
